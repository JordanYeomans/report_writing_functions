...
class SubPlot():
    ...
    def __init__(self, height, width, fig_size=(4.25,5), dpi = 220, font_fam = 'sans-serif', font_label_size = 12,
                 font_title_size = 12, tick_size = 12, figure_num = 1):
    ...
    def save_figure(self, save_name):
        self.fig = plt.savefig(save_name, pad_inches = 0, transparent=True)
